    ...
    <div className="overflow-x-auto p-6">
      <div className="mb-4">
        <button
          ...
          className="bg-black text-white px-4 py-2 rounded-md hover:bg-yellow-500 hover:text-black transition duration-300 ease-in-out transform hover:scale-105"
        >
            ...
            <tr className="bg-black text-white">
              {["ID", "Nome", "Funcionalidade", "Salário", "Ações"].map(
                (header) => (
                  <th
                    key={header}
                    className="py-3 px-6 text-left transition-colors duration-200 hover:bg-yellow-500 hover:text-black"
                  >
                    {header}
                  </th>
                )
                ...
                >
                  ...
                  <td className="py-4 px-6 border-b border-gray-200 flex space-x-2">
                    <button
                      ...
                      className="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 transform hover:scale-105 transition duration-300"
                    >
                      Editar
                    </button>
                    <button
                      onClick={() => handleDelete(employee.id)}
                      className="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transform hover:scale-105 transition duration-300"
                    >
                      Excluir
                    </button>
                  </td>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-10 rounded-lg shadow-md w-[600px] transform scale-90 transition duration-300 ease-in-out hover:scale-100 relative">
            <button
              onClick={() => setShowModal(false)}
              className="absolute top-4 right-4 text-gray-600 hover:text-black text-2xl transform hover:rotate-180 transition duration-300 ease-in-out"
            >
              &times;
            </button>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-black focus:border-black"
                  required
                />
              </div>
              <div className="mb-4">
              ...
              <div className="flex justify-between">
                ...
                <button
                  type="submit"
                  className="bg-black text-white px-4 py-2 rounded-md hover:bg-yellow-500 hover:text-black transition duration-300"
