    ...
    return (
        <div className="container mx-auto px-6 py-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center mb-10">
                <div className="card p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
                    <FaLightbulb className="text-4xl mb-4 text-black icon-rotate" />
                ...
                <div className="card p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
                    <FaUsers className="text-4xl mb-4 text-black icon-rotate" />
                ...
                <div className="card p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
                    <FaCogs className="text-4xl mb-4 text-black icon-rotate" />
                ...
                <div className="card p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
                    <FaStar className="text-4xl mb-4 text-black icon-rotate" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center mb-10">
                {teamMembers.map((member, index) => (
                    <div
                        key={index}
                        className="p-6 bg-white rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105"
                    >
                        <img
                            src={member.img}
                            alt={member.name}
