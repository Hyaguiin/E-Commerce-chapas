        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              Bem-vindo à nossa loja! Somos especializados em oferecer produtos de qualidade excepcional, 
              incluindo cavalos de alto padrão, charutos finos e whiskies premium. Cada item é cuidadosamente selecionado
               para garantir a melhor experiência. Descubra a exclusividade e a sofisticação que você merece!
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-2">
                ...
                <a href="https://github.com/Hyaguiin/E-Commerce-chapas" className="text-gray-400 hover:text-white">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8 border-t border-gray-700 pt-6 text-center">
            <p className="text-sm text-gray-400">
              © 2024  White Belt. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
